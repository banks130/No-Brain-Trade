...
TELEGRAM_SIGNAL_CHANNEL = os.getenv("TELEGRAM_SIGNAL_CHANNEL")    # channel for spike alerts
TELEGRAM_ADMIN_ID = os.getenv("TELEGRAM_ADMIN_ID")                # your Telegram user ID

# ── Solana RPC ────────────────────────────────────
SOLANA_RPC_URL = os.getenv("SOLANA_RPC_URL", "https://api.mainnet-beta.solana.com")

# ── Admin Wallet (used for paid MM, admin commands) ──
PRIVATE_KEY = os.getenv("PRIVATE_KEY")   # base58 private key – keep secret!

# ── Trading defaults (per‑user, but these are fallback defaults) ──
...
TAKE_PROFIT_LEVELS = [(2.0, 0.5), (3.0, 0.3), (5.0, 0.2)]   # (multiplier, fraction)
